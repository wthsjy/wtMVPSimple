...
public class RecyclerRefreshLayout extends ViewGroup
    ...
    public boolean onStartNestedScroll(View child, View target, int nestedScrollAxes) {
        Log.d("__","onStartNestedScroll:"+nestedScrollAxes);
    ...
    public void onNestedScrollAccepted(View child, View target, int axes) {
        Log.d("__","onNestedScrollAccepted:"+axes);
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed) {
        Log.d("__","onNestedPreScroll:"+dx+" "+dy);
    ...
    public int getNestedScrollAxes() {
        Log.d("__","getNestedScrollAxes:");
        return mNestedScrollingParentHelper.getNestedScrollAxes();
    }

    @Override
    public void onStopNestedScroll(View target) {
        Log.d("__","onStopNestedScroll:");
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed,
                               int dyUnconsumed) {
        Log.d("__","onNestedScroll:"+dxConsumed+" "+dyConsumed+" "+dxUnconsumed+" "+dyConsumed);
        if (dyUnconsumed < 0) {
    ...
    public boolean onNestedPreFling(View target, float velocityX, float velocityY) {
        Log.d("__","onNestedPreFling:"+velocityX+" "+velocityY);
        return false;
    }

    @Override
    public boolean onNestedFling(View target, float velocityX, float velocityY, boolean consumed) {
        Log.d("__","onNestedFling:"+velocityX+" "+velocityY);
        return false;
    }

    @Override
    public void setNestedScrollingEnabled(boolean enabled) {
        Log.d("__","setNestedScrollingEnabled:");
        mNestedScrollingChildHelper.setNestedScrollingEnabled(enabled);
    }

    @Override
    public boolean isNestedScrollingEnabled() {
        Log.d("__","isNestedScrollingEnabled:");
        return mNestedScrollingChildHelper.isNestedScrollingEnabled();
    }

    @Override
    public boolean startNestedScroll(int axes) {
        Log.d("__","startNestedScroll:"+axes);
        return mNestedScrollingChildHelper.startNestedScroll(axes);
    }

    @Override
    public void stopNestedScroll() {
        Log.d("__","stopNestedScroll:");
        mNestedScrollingChildHelper.stopNestedScroll();
    }

    @Override
    public boolean hasNestedScrollingParent() {
        Log.d("__","hasNestedScrollingParent:");
    ...
    public boolean dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed,
        ...
        Log.d("__","dispatchNestedScroll:"+dxConsumed+" "+dyConsumed+" "+dxUnconsumed+" "+dyConsumed);
    ...
    public boolean dispatchNestedPreScroll(int dx, int dy, int[] consumed, int[] offsetInWindow) {
        Log.d("__","dispatchNestedPreScroll:"+dx+" "+dy);
        return mNestedScrollingChildHelper.dispatchNestedPreScroll(dx, dy, consumed, offsetInWindow);
    }

    @Override
    public boolean dispatchNestedFling(float velocityX, float velocityY, boolean consumed) {
        Log.d("__","dispatchNestedFling:"+velocityX+" "+velocityY);
